...
Route::middleware('guest')->group(function () {
    ...
    // ログイン
    // 一旦, 全部ShoppingStreetControllerに書く. 
    // Route::get('login', [AuthenticatedSessionController::class, 'create'])
    //             ->name('login');
    // Route::post('login', [AuthenticatedSessionController::class, 'store']);
    Route::get('/login', [ShoppingStreetController::class, 'showLoginForm'])->name('login');
    Route::post('/login', [ShoppingStreetController::class, 'login']);
